...
public class DaftarMahasiswa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Mahasiswa[] daftarMahasiswa = mahasiswaFcd.getDaftarMahasiswa();
            ...
            for (Mahasiswa daftarMahasiswa1 : daftarMahasiswa) {
                out.println("<tr>"
                        + "<td>"+ daftarMahasiswa1.getNim() + "</td>" 
                        + "<td><a href=DataMahasiswa?nim="+daftarMahasiswa1.getNim()+">" + daftarMahasiswa1.getNama_mhs() + "</a></td>" 
                        + "<td>" + daftarMahasiswa1.getProdi() + "</td>"
                        + "</tr>");
            }
            out.println("</table>");
            out.println("</body>");
